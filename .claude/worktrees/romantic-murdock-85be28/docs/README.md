...
- [README.md](../README.md)
- [GUIA_SETORES_TECNICO_OPERACIONAL.md](GUIA_SETORES_TECNICO_OPERACIONAL.md)
- [COLA_KPIS_SETORIAIS.md](COLA_KPIS_SETORIAIS.md)
- [INVENTARIO_SUPABASE_REMOTO.md](INVENTARIO_SUPABASE_REMOTO.md)
