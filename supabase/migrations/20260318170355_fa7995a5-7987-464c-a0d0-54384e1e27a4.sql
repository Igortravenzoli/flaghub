...
INSERT INTO hub_sync_jobs (job_key, integration_id, enabled, schedule_minutes, schedule_cron)
SELECT v.job_key, v.integration_id::uuid, v.enabled, v.schedule_minutes, v.schedule_cron
FROM (VALUES
...
) AS v(job_key, integration_id, enabled, schedule_minutes, schedule_cron)
