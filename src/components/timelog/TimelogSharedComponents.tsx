...
import {
  ...
  CheckCircle2, XCircle, SendHorizonal, ThumbsDown,
} from 'lucide-react';
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2 text-xs text-muted-foreground rounded border bg-muted/20 px-3 py-2">
        ...
        <span>Selecione entradas VDESK para enfileirar. Após aprovação, a Edge Function enviará para o DevOps via TechsBCN.</span>
      </div>
