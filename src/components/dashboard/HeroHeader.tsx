  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/20 via-card to-card border border-border/50 p-8 mb-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 -left-1/4 w-96 h-96 bg-[hsl(var(--info))]/10 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div className="relative">
            ...
            <div className="relative p-4 rounded-2xl bg-gradient-to-br from-primary to-[hsl(var(--info))]">
        ...
        {/* Live indicator */}
        <div className="flex items-center gap-3 px-4 py-2 rounded-full glass border border-primary/30">
