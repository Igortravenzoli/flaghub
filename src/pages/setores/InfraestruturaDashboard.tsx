...
export default function InfraestruturaDashboard() {
  ...
  return (
    <SectorLayout title="Infraestrutura" subtitle="Atividades, Melhorias e Monitoramento" lastUpdate="" integrations={integrations} areaKey="infraestrutura" syncFunctions={[{ name: 'devops-sync-all', label: 'Sincronizar base DevOps', payload: { sector: 'infraestrutura' } },{ name: 'devops-sync-repos', label: 'Sincronizar repositórios DevOps', payload: {} }, { name: 'sharepoint-sync-sgsi', label: 'Sincronizar SGSI (SharePoint)', payload: {} }, { name: 'devops-sync-timelog', label: 'Sincronizar TimeLog (Horas)', payload: {} }]}>
